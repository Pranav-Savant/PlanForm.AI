        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-zinc-400 text-sm leading-relaxed max-w-sm">
              Autonomous structural intelligence system transforming floor plans
              into actionable insights using AI, 3D modeling, and material
              optimization.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Built for innovation challenges — combining AI, computer vision,
              and structural analysis into a unified intelligent pipeline.
            </p>
